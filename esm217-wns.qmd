...
wns_counties <- left_join(counties, wns, by = "county") %>% 
  mutate(determination = factor(determination, levels = c("Pd Presumed", "WNS Suspect", "Pd Positive", "WNS Positive")))
